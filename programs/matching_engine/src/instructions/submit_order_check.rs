use crate::COMP_DEF_OFFSET_SUBMIT_ORDER_CHECK;
use crate::SubmitOrderCheckCallback;
...
#[queue_computation_accounts("submit_order_check", user)]
#[derive(Accounts)]
#[instruction(
    amount: [u8; 32],
    price: [u8; 32],
...
pub struct SubmitOrderCheck<'info> {
    #[account(mut)]
